...
public class GameService {
    ...
    public int createGame(String authToken, String gameName) throws DataAccessException {
        ...
        //an unplayed game
        String unplayedGame = "R,N,B,Q,K,B,N,R;P,P,P,P,P,P,P,P; , , , , , , , ; , , , , , , , ; , , , , , , , ; , , , , , , , ;p,p,p,p,p,p,p,p;r,n,b,q,k,b,n,r;";

        // Create a new game with a unique game ID
        GameData newGame = new GameData(0, null, null, gameName,unplayedGame); // Game ID will be generated by GameDAO
    ...
    public void joinGame(String authToken, int gameId, String playerColor) throws DataAccessException {
        ...
        if ("WHITE".equalsIgnoreCase(playerColor)) {
            ...
            GameData updatedGame = new GameData(game.gameID(), authData.username(), game.blackUsername(), game.gameName(), game.gameState());
            ...
            // Update the game with the new player
            GameData updatedGame = new GameData(game.gameID(), game.whiteUsername(), authData.username(), game.gameName(), game.gameState());
            gameDAO.updateGame(updatedGame);
        } else {
            throw new DataAccessException("Error: bad request");
        }
